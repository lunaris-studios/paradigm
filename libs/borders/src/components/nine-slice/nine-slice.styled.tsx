...
NineSlice.Container = styled(Spring.animated.div)<INineSliceContainerProps>`
	...
	display: grid;
	grid-template-areas:
		"${Types.NineSliceCoordinate.NORTH_WEST} ${Types.NineSliceCoordinate.NORTH} ${Types
			.NineSliceCoordinate.NORTH_EAST}"
		"${Types.NineSliceCoordinate.WEST} ${Types.NineSliceCoordinate.CENTER} ${Types
			.NineSliceCoordinate.EAST}"
		"${Types.NineSliceCoordinate.SOUTH_WEST} ${Types.NineSliceCoordinate.SOUTH} ${Types
			.NineSliceCoordinate.SOUTH_EAST}";
`;
